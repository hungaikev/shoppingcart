...
class ShoppingcartEntity extends PersistentEntity {
  ...
  /**
    ...
    */
  override def initialState: ShoppingcartState = ShoppingcartState("Hello", LocalDateTime.now.toString)
...
/**
  ...
  */
case class ShoppingcartState(message: String, timestamp: String)
...
/**
  ...
  */
case class GreetingMessageChanged(message: String) extends ShoppingcartEvent
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends ShoppingcartCommand[String]
